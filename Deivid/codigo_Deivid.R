...
plot.ts(residuals(modelo1), ylab = "Residuales del modelo 1")
abline(h=c(-2*sqrt(modelo1$sigma2),0,2*sqrt(modelo1$sigma2)),col=2)
plot(as.numeric(modelo1$fitted),residuals(modelo1), xlab = "Índice de ventas nominales ajustados del modelo 1", ylab = "Residuales del modelo 1")
abline(h=c(-2*sqrt(modelo1$sigma2),0,2*sqrt(modelo1$sigma2)),col=2)
acf(as.numeric(residuals(modelo1)),ci.type="ma",lag.max=36, main = "ACF del modelo 1")
pacf(as.numeric(residuals(modelo1)),lag.max=36, main = "PACF del modelo 1")

#layout(rbind(c(1,2),c(3,4)))
plot.ts(residuals(modelo2), ylab = "Residuales del modelo 2")
abline(h=c(-2*sqrt(modelo2$sigma2),0,2*sqrt(modelo2$sigma2)),col=2)
plot(as.numeric(modelo2$fitted),residuals(modelo2), xlab = "Índice de ventas nominales ajustados del modelo 2", ylab = "Residuales del modelo 2")
abline(h=c(-2*sqrt(modelo2$sigma2),0,2*sqrt(modelo2$sigma2)),col=2)
acf(as.numeric(residuals(modelo2)),ci.type="ma",lag.max=36, main = "ACF del modelo 2")
pacf(as.numeric(residuals(modelo2)),lag.max=36, main = "PACF del modelo 2")

#layout(rbind(c(1,2),c(3,4)))
plot.ts(residuals(modelo3), ylab = "Residuales del modelo 3")
abline(h=c(-2*sqrt(modelo3$sigma2),0,2*sqrt(modelo3$sigma2)),col=2)
plot(as.numeric(modelo3$fitted),residuals(modelo3), xlab = "Índice de ventas nominales ajustados del modelo 3", ylab = "Residuales del modelo 3")
abline(h=c(-2*sqrt(modelo3$sigma2),0,2*sqrt(modelo3$sigma2)),col=2)
acf(as.numeric(residuals(modelo3)),ci.type="ma",lag.max=36, main = "ACF del modelo 3")
pacf(as.numeric(residuals(modelo3)),lag.max=36, main = "PACF del modelo 3")

#layout(rbind(c(1,2),c(3,4)))
plot.ts(residuals(modelo4), ylab = "Residuales del modelo 4")
abline(h=c(-2*sqrt(modelo4$sigma2),0,2*sqrt(modelo4$sigma2)),col=2)
plot(as.numeric(modelo4$fitted),residuals(modelo4), xlab = "Índice de ventas nominales ajustados del modelo 4", ylab = "Residuales del modelo 4")
abline(h=c(-2*sqrt(modelo4$sigma2),0,2*sqrt(modelo4$sigma2)),col=2)
acf(as.numeric(residuals(modelo4)),ci.type="ma",lag.max=36, main = "ACF del modelo 4")
pacf(as.numeric(residuals(modelo4)),lag.max=36, main = "PACF del modelo 4")
...
qqnorm(residuals(modelo1),main="Q-Q plot para normalidad del modelo 1")
qqline(residuals(modelo1),col="red")
qqnorm(residuals(modelo2),main="Q-Q plot para normalidad del modelo 2")
qqline(residuals(modelo2),col="red")
qqnorm(residuals(modelo3),main="Q-Q plot para normalidad del modelo 3")
qqline(residuals(modelo3),col="red")
qqnorm(residuals(modelo4),main="Q-Q plot para normalidad del modelo 4")
qqline(residuals(modelo4),col="red")